...
const styles: Record<PillVariant, string> = {
  Research: "bg-slate-500/10 text-slate-300 border-slate-500/30",
  "Proof of Concept": "bg-amber-500/10 text-amber-400 border-amber-500/30",
  ...
  return (
    <span
      className={clsx(
        ...
        styles[variant] ?? "bg-slate-500/10 text-slate-300 border-slate-500/30"
      )}
    >
      {label}
    </span>
