...
export const DB_CBDC_COUNT_EXTERNAL_ESTIMATE = 115; // Kiffmeister (Apr 2026): ~115 jurisdictions with any historical retail CBDC exploration
export const DB_LAUNCHED_EXTERNAL = 4;  // Kiffmeister active-launch count (Mar 2026)
export const DB_PILOT_EXTERNAL = 12;    // Kiffmeister active-pilot count (Mar 2026)
export const DB_POC_EXTERNAL = 22;      // Kiffmeister active-PoC count (Mar 2026)
export const DB_RESEARCH_EXTERNAL = 77; // Kiffmeister research count (Mar 2026)
...
export const cbdcProjects: CBDCProject[] = [
  ...
  },
  {
    ...
    stage: "Pilot",
    type: "Retail",
    techStack: "Multi-platform (centralized + DLT variants)",
    technologyProvider: "HKMA / Multiple vendors",
    ...
    region: "Asia",
    isoNumeric: "344",
    description: "The HKMA completed Phase 1 of its e-HKD Pilot Programme in 2023, with 14 selected firms testing six use cases across full-fledged payments, programmable payments, offline payments, tokenised deposits, settlement of Web3 transactions, and settlement of tokenised assets. Phase 2 focuses on deepening two key use cases: settlement of tokenised assets and programmable payments.",
    whitepapers: [
      { title: "e-HKD Pilot Programme Phase 1 Report", url: "https://www.hkma.gov.hk/media/eng/doc/key-information/press-release/2023/20231030e3a1.pdf" },
      { title: "e-HKD: A Policy and Design Perspective", url: "https://www.hkma.gov.hk/media/eng/doc/key-information/press-release/2022/20220630e3a1.pdf" },
    ],
    ...
    architecture: {
      ...
      programmable: true,
      interestBearing: false,
      notes: "Phase 1 deliberately avoided prescribing a single architecture — different participating firms tested centralized and DLT-based models in parallel. Phase 2 concentrates on programmable payments (using smart contracts for purpose-bound money similar to Singapore's PBM concept) and tokenised asset settlement. Offline capability was tested by one pilot firm. The multi-model approach is intentional: HKMA is using the pilot to evaluate architectures rather than commit to one.",
    },
    riskProfile: {
      financial: 2,
      privacy: 3,
      ...
      adoption: 2,
      geopolitical: 4,
      notes: "Geopolitical risk is elevated by Hong Kong's special status under 'one country, two systems' — any e-HKD system must navigate the relationship with mainland China's e-CNY and potential pressure for interoperability. Privacy risk is moderate: HKMA has committed to privacy protections, but Hong Kong's changed political environment since 2020 creates uncertainty. Financial and cyber risks are well-managed given Hong Kong's sophisticated financial regulatory infrastructure.",
    },
    designRationale: "HKMA's approach is notably rigorous: use a structured pilot with diverse private sector participants to empirically test multiple architectures before committing to a design. The focus on programmable payments and tokenised asset settlement in Phase 2 reflects Hong Kong's ambition to maintain its position as Asia's leading financial centre in the era of tokenisation. The e-HKD is also positioned as complementary to, rather than competing with, the e-CNY.",
    interoperabilityDetails: "HKMA is participating in Project mBridge (multi-CBDC cross-border platform alongside PBOC, BOT, and CBUAE). e-HKD design explicitly considers interoperability with the e-CNY for cross-border retail payments under the Greater Bay Area initiative. Also exploring interoperability with tokenised asset platforms.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    id: "are",
    tag: "digital-dirham",
    country: "UAE",
    currencyName: "Digital Dirham",
    stage: "Pilot",
    type: "Both",
    techStack: "G+D Filia (Retail) / R3 Corda (Wholesale)",
    technologyProvider: "G+D (Giesecke+Devrient) / R3",
    ...
    region: "Asia",
    isoNumeric: "784",
    description: "The CBUAE launched its CBDC strategy ('Financial Infrastructure Transformation Programme') in 2023, selecting G+D Filia for the retail Digital Dirham and R3 Corda for wholesale. The UAE has a dual-track approach: retail CBDC for domestic financial inclusion and cross-border payments, and wholesale CBDC for interbank settlement. The UAE is one of the most internationally active CBDC participants through mBridge.",
    whitepapers: [
      { title: "CBUAE CBDC: Financial Infrastructure Transformation Programme", url: "https://www.centralbank.ae/en/our-operations/digital-dirham" },
    ],
    ...
    architecture: {
      ...
      programmable: false,
      interestBearing: false,
      notes: "Retail track uses G+D Filia — a hardware-based token platform with offline capability via secure chip. Wholesale track uses R3 Corda for interbank settlement. The dual-track architecture reflects the UAE's two distinct use cases: domestic financial inclusion (retail) and international trade settlement (wholesale). G+D Filia was also chosen by Ghana (eCedi), indicating a possible interoperability path between Gulf and African implementations.",
    },
    riskProfile: {
      financial: 2,
      privacy: 4,
      ...
      adoption: 2,
      geopolitical: 4,
      notes: "Privacy risk is high: the UAE government has extensive surveillance capabilities and no constitutional privacy protections comparable to Western standards. Geopolitical risk is significant — the UAE is deeply embedded in both Western financial systems and the mBridge network which is under scrutiny as a potential sanctions-circumvention tool. The UAE's decision to join mBridge alongside China and Russia creates complex positioning. Financial risk is low given the dirham's dollar peg and the UAE's strong fiscal position.",
    },
    designRationale: "The UAE's CBDC strategy is driven by: (1) ambition to be the premier digital finance hub in the Middle East and Africa region, (2) reducing dependence on correspondent banking for cross-border payments (UAE is a major remittance sending country), (3) supporting the broader Financial Infrastructure Transformation Programme which also includes tokenised assets and instant payments. The G+D Filia hardware choice for retail reflects the need to serve a large migrant worker population who may lack smartphones.",
    interoperabilityDetails: "Active mBridge participant alongside PBOC, HKMA, and Bank of Thailand — the most operationally advanced multi-CBDC cross-border platform globally. Exploring bilateral CBDC corridors for India-UAE remittances (major corridor: UAE hosts ~3.5M Indian workers). Also participating in Project Agorá (BIS) for tokenised cross-border payments.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "digital-tenge",
    country: "Kazakhstan",
    currencyName: "Digital Tenge",
    stage: "Pilot",
    type: "Retail",
    techStack: "National Bank of Kazakhstan Platform",
    technologyProvider: "National Bank of Kazakhstan",
    centralBank: "National Bank of Kazakhstan (NBK)",
    announcementYear: 2021,
    updateRate: "Quarterly",
    usesDLT: false,
    interoperable: false,
    region: "Asia",
    isoNumeric: "398",
    description: "Kazakhstan launched its Digital Tenge pilot in 2023, making it one of the more advanced CBDC programs among Central Asian economies. The National Bank conducted real transactions with a select group of participants and has been gradually expanding the pilot. Kazakhstan's motivation includes reducing cash usage, improving payment system efficiency, and positioning the country as a digital finance leader in the region.",
    whitepapers: [
      { title: "Digital Tenge — National Bank of Kazakhstan", url: "https://nationalbank.kz/en/news/digital-tenge" },
    ],
    ...
    architecture: {
      ...
      programmable: true,
      interestBearing: false,
      holdingLimit: "1,000,000 tenge per wallet",
      notes: "Centralized platform (not DLT). Programmability is a stated feature for targeted social payments and government subsidies. Two-tier distribution through commercial banks. Full KYC required. The NBK has described planned use cases including programmable transfers for targeted social assistance — following the Indian e₹ model of purpose-bound welfare payments.",
    },
    riskProfile: {
      financial: 2,
      privacy: 4,
      ...
      adoption: 2,
      geopolitical: 3,
      notes: "Privacy risk is high — Kazakhstan is an authoritarian state with extensive government surveillance and no meaningful data protection framework. Geopolitical risk is moderate: Kazakhstan is in Russia's economic orbit (Eurasian Economic Union member) and under pressure to align with Russia's digital ruble corridor, while also seeking Western investment. The 2022 civil unrest and subsequent government crackdown highlighted how digital payment infrastructure can be used for financial monitoring of dissent.",
    },
    designRationale: "Kazakhstan's CBDC rationale is driven by: (1) reducing the large informal/cash economy, (2) enabling programmable government-to-person payments to reduce subsidy leakage, (3) regional positioning as a digital finance leader among Central Asian nations. Kazakhstan also sees CBDC as part of its broader strategy to develop Astana International Financial Centre as a regional hub. The non-DLT centralized design reflects cost and technical capacity considerations.",
    interoperabilityDetails: "Exploring CBDC interoperability within the Eurasian Economic Union (Russia, Belarus, Armenia, Kyrgyzstan, Kazakhstan). Under pressure from Russia to connect with the digital ruble corridor. No operational cross-border CBDC links established.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "digital-lira",
    country: "Turkey",
    currencyName: "Digital Lira",
    stage: "Pilot",
    type: "Retail",
    techStack: "CBRT Platform (Proprietary)",
    technologyProvider: "Central Bank of the Republic of Turkey (CBRT)",
    ...
    region: "Europe",
    isoNumeric: "792",
    description: "The CBRT completed its first Digital Lira transactions in 2023 under its CBDC pilot, operating under the Digital Turkish Lira Collaboration Platform. The pilot is notable for running during a period of extreme currency volatility — Turkey experienced hyperinflation exceeding 80% — which gives the digital lira pilot an unusual economic context compared to most CBDC programs.",
    whitepapers: [
      { title: "Digital Turkish Lira Research and Development", url: "https://www.tcmb.gov.tr/wps/wcm/connect/EN/TCMB+EN/Main+Menu/Core+Functions/Payment+Systems/Digital+Turkish+Lira" },
    ],
    ...
    architecture: {
      ...
      programmable: false,
      interestBearing: false,
      notes: "The CBRT built a proprietary centralized platform (not DLT). Token-based design. The pilot ran with participating banks and technology companies on a permissioned network. Turkey's high inflation context means a non-interest-bearing CBDC has negative real returns — potentially limiting its attractiveness as a store of value, but reinforcing its use purely as a payment instrument.",
    },
    riskProfile: {
      financial: 3,
      privacy: 3,
      ...
      adoption: 3,
      geopolitical: 2,
      notes: "Financial risk is elevated because Turkey's monetary instability means citizens have strong incentives to convert digital lira holdings to foreign currency or gold — a CBDC could accelerate this flight in a crisis. Privacy risk is moderate: Turkey has data protection law but government surveillance capabilities are extensive. Adoption risk is real: dollarization of savings is already high; a digital lira doesn't solve the fundamental trust problem with the currency.",
    },
    designRationale: "Turkey's CBDC motivation differs from most: the primary driver is improving the efficiency of the payment system and reducing dependency on international payment networks (Visa/Mastercard), particularly in a context where Turkey faces Western political pressure. A secondary motivation is reducing dollarization by offering a modern digital alternative to the physical lira. The non-DLT centralized design reflects the CBRT's preference for control and auditability.",
    interoperabilityDetails: "No operational cross-border CBDC interoperability. Turkey is exploring connections to regional payment systems. Given Turkey's geopolitical position straddling NATO and Russia relationships, CBDC interoperability choices are politically sensitive.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "digital-won",
    country: "South Korea",
    currencyName: "Digital Won",
    stage: "Proof of Concept",
    type: "Retail",
    techStack: "Kakao Ground X / Custom Platform",
    technologyProvider: "Bank of Korea / Ground X",
    ...
    region: "Asia",
    isoNumeric: "410",
    description: "The Bank of Korea completed multiple PoC phases testing CBDC technology, and in 2023 ran a pilot involving approximately 100,000 participants through selected commercial banks. The BOK has tested offline payment capability and programmable features. South Korea's highly advanced digital payments market — one of the most cashless societies globally — means the BOK is focused on whether CBDC can offer meaningful improvements over existing infrastructure.",
    whitepapers: [
      { title: "Bank of Korea CBDC", url: "https://www.bok.or.kr/eng/main/contents.do?menuNo=400213" },
    ],
    ...
    architecture: {
      ...
      programmable: true,
      interestBearing: false,
      notes: "The BOK tested both DLT and centralized approaches in different PoC phases. Partnership with Ground X (Kakao's blockchain subsidiary) brought DLT expertise. Offline capability was a specific test case. Programmability was explored for conditional payments. South Korea's existing Kakao Pay and Samsung Pay ecosystems mean the BOK is studying whether CBDC infrastructure can add capabilities these private systems lack — particularly programmability and offline settlement.",
    },
    riskProfile: {
      financial: 2,
      privacy: 2,
      ...
      adoption: 3,
      geopolitical: 3,
      notes: "Adoption risk is the primary challenge: South Korea already has 97%+ digital payment penetration with fast, low-cost private payment options. The BOK's own research questions whether retail CBDC offers sufficient benefit. Geopolitical risk is moderate: North Korea's sophisticated cyber capabilities make South Korean CBDC infrastructure a potential target; the North has previously stolen cryptocurrency from South Korean exchanges. Privacy risk is low — South Korea has strong data protection law (PIPA) and independent regulators.",
    },
    designRationale: "The BOK is proceeding cautiously and methodically: run PoC phases, evaluate evidence, avoid premature commitment. The focus on whether CBDC adds value over existing infrastructure reflects academic rigour — the BOK publishes some of the most technically detailed CBDC research papers among Asian central banks. The pilot with 100,000 participants was designed as an evidence-gathering exercise rather than a launch. Korea's experience with the COVID-era disaster relief vouchers (programmable payments via credit cards) informs thinking on programmable CBDC use cases.",
    interoperabilityDetails: "Exploring interoperability as part of BIS research networks. No operational cross-border CBDC links. Some research into Korea-Japan payment corridor given large bilateral trade flows.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "digital-shekel",
    country: "Israel",
    currencyName: "Digital Shekel",
    stage: "Proof of Concept",
    type: "Retail",
    techStack: "TBD / Research Phase",
    technologyProvider: "Bank of Israel",
    ...
    region: "Asia",
    isoNumeric: "376",
    description: "The Bank of Israel ran a digital shekel hackathon in 2023 with 33 teams, generating proposals for CBDC use cases and technical approaches. The Bank published a detailed 'Digital Shekel Challenge' report summarising findings. Israel has taken a thoughtful, evidence-first approach — publishing comprehensive design documents before committing to any platform. The Bank concluded that programmable payments and offline capability are the features that would differentiate a digital shekel from existing payment infrastructure.",
    whitepapers: [
      { title: "Digital Shekel Challenge — Summary Report", url: "https://www.boi.org.il/en/communication-and-publications/press-releases/digital-shekel-challenge-summary-report/" },
      { title: "Potential benefits and risks of a digital shekel", url: "https://www.boi.org.il/en/communication-and-publications/research/potential-benefits-and-risks-of-a-digital-shekel/" },
    ],
    ...
    architecture: {
      ...
      programmable: true,
      interestBearing: false,
      notes: "No platform selected yet. The Bank of Israel's hackathon and research has converged on a token-based model with programmability as the key differentiator. The Bank has been explicit that a digital shekel would only be issued if it offers advantages over existing payment infrastructure — and has identified programmable conditional payments (escrow, DvP, purpose-bound transfers) and offline capability as the primary candidates. Privacy-preserving approaches were a key hackathon evaluation criterion.",
    },
    riskProfile: {
      financial: 2,
      privacy: 2,
      ...
      adoption: 3,
      geopolitical: 3,
      notes: "Israel has a highly developed digital payments market (credit cards dominant, instant payments available), making the adoption case uncertain. Geopolitical risk is moderate: a digital shekel could be relevant for sanctions-resilient payment corridors given Israel's complex regional relationships. Cyber risk is low given Israel's world-class cybersecurity sector — the Bank of Israel can draw on deep technical expertise. Privacy has been a prominent design consideration in published research.",
    },
    designRationale: "The Bank of Israel's approach is the most analytically rigorous among smaller advanced economies: publish risk/benefit analysis, run an open hackathon, evaluate results, then decide. The Bank has been transparent that it may conclude a digital shekel is not warranted. The programmability focus reflects Israel's strong fintech sector — the hackathon surfaced use cases including real estate DvP, cross-border micropayments for digital services, and conditional payroll for gig workers.",
    interoperabilityDetails: "Exploring potential cross-border CBDC use cases with trading partners. No operational interoperability. Participating in BIS research. Regional payment corridor potential is complex given Middle East geopolitics.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "e-krone-no",
    country: "Norway",
    currencyName: "e-Krone (Norges Bank)",
    stage: "Proof of Concept",
    type: "Retail",
    techStack: "Nahmii (Ethereum L2)",
    technologyProvider: "Nahmii AS",
    ...
    region: "Europe",
    isoNumeric: "578",
    description: "Norges Bank completed Phase 4 of its CBDC exploration in 2024, selecting Nahmii — a Norwegian Ethereum Layer 2 solution — as its open-source sandbox technology. Norway's CBDC work is distinct from Sweden's (e-krona): both are Scandinavian cashless societies, but Norges Bank is still actively exploring while Riksbank has effectively paused. Norway's motivation is preserving access to a public payment option as cash declines.",
    whitepapers: [
      { title: "Norges Bank CBDC — Phase 4 Report", url: "https://www.norges-bank.no/en/topics/payment-systems/digital-krone/" },
    ],
    ...
    architecture: {
      ...
      programmable: true,
      interestBearing: false,
      notes: "Nahmii is an Ethereum L2 (optimistic rollup architecture) providing fast, low-cost transactions with Ethereum's security guarantees. The open-source approach is notable: Norges Bank has published all technical work publicly. DLT was specifically chosen to explore decentralized architecture options distinct from Sweden's centralized e-krona approach. No offline capability in current design. Programmability via Ethereum's smart contract layer is available but not a primary focus.",
    },
    riskProfile: {
      financial: 2,
      privacy: 2,
      ...
      adoption: 4,
      geopolitical: 1,
      notes: "Adoption risk remains Norway's primary challenge — like Sweden, Norway already has excellent digital payments (Vipps handles most P2P payments; BankAxept covers card payments). The case for adding a CBDC to this landscape is not obvious. Norges Bank's own analysis has been cautious about this. Privacy is well-protected under Norwegian law. Geopolitical risk is minimal. The Ethereum L2 choice introduces smart contract risk but Norges Bank's sandbox approach manages this.",
    },
    designRationale: "Norges Bank's rationale mirrors the broader Scandinavian concern: cash use has declined so rapidly that without a CBDC, citizens would have no public fallback if private payment providers fail or exclude users. Unlike Sweden (which effectively concluded CBDC isn't needed yet), Norges Bank is still exploring whether an e-krone could serve as that insurance policy. The Ethereum L2 choice reflects openness to DLT architectures and Norway's active blockchain sector. The open-source approach ensures transparency and supports policy credibility.",
    interoperabilityDetails: "Norway is not an EU member but has a close relationship with the ECB's digital euro project through the EEA. If the digital euro launches, Norway would likely need to integrate or offer parallel access. Participating in BIS cross-border CBDC research. No operational cross-border links.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
  {
    ...
    tag: "digital-baht",
    country: "Thailand",
    currencyName: "Digital Baht",
    stage: "Proof of Concept",
    type: "Both",
    techStack: "Project Inthanon (R3 Corda) / Retail PoC",
    technologyProvider: "Bank of Thailand / Multiple",
    ...
    region: "Asia",
    isoNumeric: "764",
    description: "Thailand has two parallel CBDC tracks: wholesale CBDC (Project Inthanon, now operationally mature) and retail CBDC (PoC completed in 2022-2023 with limited participants). The BOT has been cautious about retail CBDC, citing Thailand's already well-developed PromptPay instant payment system. The BOT is an active participant in mBridge for cross-border wholesale CBDC.",
    whitepapers: [
      { title: "Bank of Thailand CBDC", url: "https://www.bot.or.th/en/financial-innovation/digital-finance/cbdc.html" },
      { title: "Project Inthanon", url: "https://www.bot.or.th/en/financial-innovation/digital-finance/cbdc/project-inthanon.html" },
    ],
    ...
    architecture: {
      ...
      programmable: false,
      interestBearing: false,
      notes: "Wholesale track (Project Inthanon): built on R3 Corda, used for domestic interbank bond settlement and cross-border FX via mBridge. Retail track: separate PoC with limited scope, testing basic payment functionality. BOT has been explicit that retail CBDC will only advance if it clearly adds value beyond PromptPay, which already handles real-time retail payments for free. The two-track approach mirrors Australia and Singapore in separating wholesale (where benefits are clear) from retail (where the case is uncertain).",
    },
    riskProfile: {
      financial: 2,
      privacy: 3,
      ...
      adoption: 3,
      geopolitical: 2,
      notes: "Adoption risk is Thailand's main challenge — PromptPay has over 70 million registered accounts in a country of 72 million people, achieving near-universal penetration faster than almost any payment system globally. A retail CBDC must differentiate against this baseline. Privacy risk is moderate: Thailand has a Personal Data Protection Act (2019) but enforcement is limited. Geopolitical risk is low-moderate: Thailand's participation in mBridge alongside China creates some geopolitical complexity.",
    },
    designRationale: "Thailand's approach: run wholesale CBDC first where benefits are proven (interbank settlement efficiency, cross-border payments), and treat retail CBDC as contingent on demonstrating clear additional value. This evidence-based sequencing is consistent with the BOT's generally analytical approach to financial innovation. The mBridge participation reflects Thailand's major role in cross-border trade payment flows (tourism, manufacturing supply chains).",
    interoperabilityDetails: "Active mBridge participant alongside PBOC, HKMA, and CBUAE. Project Inthanon Phase 3 tested cross-border FX settlement with HKMA. Also participating in Project Nexus (BIS multi-country instant payment connectivity). Thailand's cross-border payment focus reflects its large tourism receipts and manufacturing supply chain payments.",
    lastVerifiedAt: "2026-04-27",
    confidence: "Medium",
  },
];
