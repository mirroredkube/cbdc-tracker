...
export type Era = "foundational" | "current" | "archive";
...
export const researchPapers: ResearchPaper[] = [
  ...
  // ── FOUNDATIONAL ──────────────────────────────────────────────────────────────
  // Core frameworks and taxonomies. These define the vocabulary and mental models
  // of the CBDC field. Read these first — they don't go out of date.

  {
    id: "bis-bech-garratt-2017",
    era: "foundational",
    title: "Central bank cryptocurrencies",
    authors: ["Morten L. Bech", "Rodney Garratt"],
    institution: "BIS",
    date: "2017-09",
    url: "https://www.bis.org/publ/qtrpdf/r_qt1709f.htm",
    abstract: "The paper that introduced the 'Money Flower' — a Venn diagram taxonomy classifying all forms of money by four properties: widely accessible, peer-to-peer, central bank issued, and electronic. Published in the BIS Quarterly Review, it introduced the vocabulary the entire CBDC field now uses, including the retail vs. wholesale distinction. If the Bitcoin whitepaper defined crypto, this paper defined CBDC.",
    tags: ["architecture", "retail-CBDC", "wholesale-CBDC", "comparative", "governance"],
    relevantCbdcIds: [],
    keyFindings: [
      "The 'Money Flower' classifies money by four properties — widely accessible, peer-to-peer transfer, central bank issued, electronic — CBDC sits at the unique intersection of the first, third, and fourth",
      "Retail CBDC (general purpose, widely accessible) is a fundamentally new form of central bank money with no historical precedent",
      "Wholesale CBDC is a narrower evolution of existing central bank reserves, making it lower risk and technically simpler",
      "This paper introduced the retail vs. wholesale CBDC distinction that became the field's canonical taxonomy — every subsequent CBDC paper builds on this framework",
    ],
  },
  {
    id: "bis-cpmi-d174",
    ...
    authors: ["CPMI", "Markets Committee"],
    institution: "BIS",
    date: "2018-03",
    url: "https://www.bis.org/cpmi/publ/d174.htm",
    abstract: "The foundational BIS joint report by the Committee on Payments and Market Infrastructures and the Markets Committee that formalised the Money Flower taxonomy into policy analysis. The report analyses both wholesale and general-purpose CBDC implications for payments, monetary policy, and financial stability — and remains the definitive institutional statement on CBDC design principles.",
    tags: ["retail-CBDC", "wholesale-CBDC", "architecture", "monetary-policy", "financial-stability", "governance"],
    relevantCbdcIds: [],
    keyFindings: [
      "The Money Flower maps money on four axes — issuer (central bank vs other), form (electronic vs physical), accessibility (wide vs restricted), transfer mechanism (token vs account) — placing CBDC in a unique intersection",
      "General-purpose CBDC accessible to the public would be fundamentally different from existing central bank money and could reshape the monetary system",
      "Wholesale CBDC for interbank settlement is a lower-risk evolution of existing central bank reserves, already feasible with current technology",
      "CBDC could disintermediate commercial banks if widely adopted, as households could shift deposits directly to the central bank",
      "No jurisdiction was ready to issue general-purpose CBDC in 2018; the report flagged financial stability risks as the primary barrier",
      "The token vs account distinction is critical for privacy and AML design — token-based CBDC is closer to physical cash, account-based requires identity verification",
    ],
  },
  {
  ...
  // ── CURRENT RESEARCH ──────────────────────────────────────────────────────────
  // Empirical results from live programs, active pilot analyses, and ongoing
  // policy debates. These reflect what is happening now.
  ...
  // ── ARCHIVE ───────────────────────────────────────────────────────────────────
  // Early surveys from before major pilots launched. Essential for understanding
  // how the field evolved, but figures and predictions have since been updated.

  {
    ...
    abstract: "This paper surveys central bank research and policy work on CBDC as of 2019. It maps key design choices and predicts issuance timelines that have since been revised. Read for historical context on how the field's consensus evolved.",
  ...
  },
  {
    ...
    abstract: "An early empirical analysis of what drives countries to research and develop CBDCs, written before the eNaira, Sand Dollar, or e-CNY full rollouts. The geopolitical drivers analysis (especially re: China) remains relevant; the timeline predictions have not held.",
