...
export const researchPapers: ResearchPaper[] = [
  ...
  },
  {
    ...
    abstract: "The foundational BIS joint report by the Committee on Payments and Market Infrastructures and the Markets Committee that popularised the 'Money Flower' taxonomy — a four-property framework (central bank issued, widely accessible, electronic, token-based) for classifying all forms of money and situating CBDCs within it. The report analyses both wholesale and general-purpose CBDC implications for payments, monetary policy, and financial stability.",
